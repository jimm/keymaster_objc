...
- Handle display and reading of missing block text for triggers and filters
  ...
  representation sometimes isn't. See the "Editing KeyMaster File" section
  of the "KeyMaster Files" help file.)
...
- Added missing DSL stop_bytes method so KeyMaster files can now specify
